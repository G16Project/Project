...
privileged aspect EmployeeIntegrationTest_Roo_IntegrationTest {
    ...
    public void EmployeeIntegrationTest.testFindEmployee() {
        ...
        Assert.assertEquals("Find method for 'Employee' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void EmployeeIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Employee' identifier to be null", obj.getId_());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Employee' identifier to no longer be null", obj.getId_());
    }
